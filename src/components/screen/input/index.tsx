...
// Linha 12 - Aqui definimos um componente chamado Input, que é uma função que recebe um conjunto de propriedades (props).
...
export const Input: React.FunctionComponent<TextInputProps> = ({ ...otherProps }: PropsWithChildren<TextInputProps>) => { return (
    <Container>
